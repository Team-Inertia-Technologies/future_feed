...
try {
    ...
    $q = "INSERT INTO user
              (iUserID, vName, vEmail, vPassword, vMobile, dDOB, vGoogleID, vPic, cStatus, cEmailVerified)
          VALUES
              ($id, '$name_esc', '$email_esc', '$password_esc', '$mobile_esc', '$DOB', '$google_esc', '$picture_esc', 'A', 'N')";
